package com.example.vinhphuc.udacitysunshine.utilities;
...
import com.example.vinhphuc.udacitysunshine.DetailActivity;
...
public class NotificationUtils {
    ...
    public static void notifyUserOfNewWeather(Context context) {
        Uri todaysWeatherUri = WeatherContract.WeatherEntry
                .buildWeatherUriWithDate(SunshineDateUtils.
                        normalizeDate(System.currentTimeMillis()));
